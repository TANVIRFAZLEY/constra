...
//changes 110,111,297 line


// Check if Class Exists.
if ( ! class_exists( 'Constra_Bootstrap_Navwalker' ) ) :
	/**
	 * Constra_Bootstrap_Navwalker class.
	 */
	class Constra_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = null, $id = 0 ) {
			...
			//$output .= ($depth ==0 && $args->walker->has_children)? '<i class="fa fa-angle-down"></i>':'';
			...
			//my code
			$item_output .= ($depth ==0 && $args->walker->has_children)? '  <i class="fa fa-angle-down"></i>':'';
